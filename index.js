...
const token = "NjkzOTM0MDYxOTE1MzQwODEw.XoaRmQ.GMK0CivJMFx16Lh3dXUy1QRHNDw";
...
// starship
members.push('326852886178824192');
limes.push(2460142069);
...
// Kailey 2
members.push('595130942943920161');
limes.push(50);

// Zelly
members.push('474682203138162698');
limes.push(50);

// Doki
members.push('320622545869078528');
limes.push(14);

// Magerlyy
members.push('322395175752171520');
limes.push(5);

// Dragon Meliodas
members.push('225972156121612288');
limes.push(10);

// cece
members.push('598345175978475551');
limes.push(10);

// cake13131313
members.push('696496988182675538');
limes.push(10);

// blueaida
members.push('696499926586228786');
limes.push(10);

// Kanye West
members.push('505159802377207809');
limes.push(10);
...
client.on('message', message => {
	...
	if(message.content.startsWith(`${prefix}count`)) {
		if(message.member.id == '281525414520946689' ||
		message.member.hasPermission("MANAGE_CHANNELS")){
			...
			message.channel.send('This is a high-command only command.');	
		}
	}
